...
## 4. Итоги
Освоены основы Android-разработки: созданы интерфейсы с LinearLayout, TableLayout, ConstraintLayout. Настроена система ресурсов, реализована адаптация под ориентацию экрана. Изучены два метода обработки событий UI на Java — программный и декларативный. Проект протестирован на эмуляторе Android Studio.
